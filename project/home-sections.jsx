...
function Bestsellers() {
  const picks = [
    { tag: 'Bestseller', name: 'Smash Burger Tacos', price: '14.35', desc: 'Mini bacon smash burgers in street tacos.', glyph: 'S', color: 'color-1' },
    { tag: '', name: 'Hot Honey Chicken', price: '15.50', desc: 'Spicy crispy chicken on brioche.', glyph: 'H', color: 'color-2' },
    { tag: '', name: 'Pastrami Reuben', price: '15.00', desc: 'Marble rye, swiss, sauerkraut.', glyph: 'P', color: 'color-3' },
    { tag: '', name: 'Herb Butter Rib Eye', price: '32.00', desc: '12oz with pesto mash and beans.', glyph: 'R', color: 'color-4' },
  ];
  return (
          ...
          {picks.map((p, i) => (
            <article key={i} className={`dish ${p.color}`}>
              ...
              <div className="dish-body">
                ...
                <button className="dish-cta">Order Now</button>
              </div>
            </article>
          ))}
        </div>
